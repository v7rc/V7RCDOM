...
// L9110S馬達模組可以參考：
// https://cavedu.gitbook.io/cavedu/rk002/module/002_l9110s_motor
...
int dcMotorPinA[] = {A0, A1};     // DC motor A
int dcMotorPinB[] = {A2, A3};     // DC motor B
...
//    Serial.println(mapValue(P5Value));
    ...
    processDCMotor(Tank0, dcMotorPinA);
    processDCMotor(Tank1, dcMotorPinB);
